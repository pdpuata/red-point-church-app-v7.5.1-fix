...
console.log('\n1. Local files');
 for (const f of ['.env.example','.supabase.production.env.example','supabase/DEPLOYMENT_ORDER.md','supabase/functions/register-device/index.ts','supabase/functions/send-push/index.ts','supabase/functions/submit-visitor/index.ts','supabase/functions/sync-youtube-sermons/index.ts','supabase/functions/sync-podcast-sermons/index.ts']) {
