...
const checks = [
  ...
  ['Admin RLS security fix', 'supabase/migrations/20260903_000002_admin_rls_fix.sql'],
  ['Production hardening migration', 'supabase/migrations/20260904_production_backend.sql'],
  ['Sermon audio source migration', 'supabase/migrations/20260904_sermon_audio_source.sql'],
  ['Table grants migration', 'supabase/migrations/20260905_table_grants.sql'],
  ['Sermon source GUID migration', 'supabase/migrations/20260906_sermon_source_guid.sql'],
...
console.log('COMPUTER: npx supabase functions deploy sync-podcast-sermons');
