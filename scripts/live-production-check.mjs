...
await check('Supabase API reachable', `${supabase}/rest/v1/`, { headers }, [200, 401, 404]);
...
await check('Published ministries endpoint', `${supabase}/rest/v1/ministries?select=id&published=eq.true&limit=1`, { headers }, [200]);
